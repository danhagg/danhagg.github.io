...
![image](/images/htb.png "Some of the nodes from my HackTheBox activity")
...
![image](/images/cherry_summary.png "OSCP exam notes")
...
1. Watch a lot of HackTheBox & Ippsec
2. Nail the Buffer Overflow
3. A relative disregard for the PWK material and labs (not including Buffer Overflow).
4. Make extensive CherryTree Notes on HackTheBox and BufferOverflow
5. A later-in-the-day exam start with some planned sleep in the middle of the night.
